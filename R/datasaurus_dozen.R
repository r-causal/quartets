...
#'
#' @references   Davies R, Locke S, D'Agostino McGowan L (2022). _datasauRus: Datasets from the
#' Datasaurus Dozen_. R package version 0.1.6, <https://CRAN.R-project.org/package=datasauRus>.
#'
